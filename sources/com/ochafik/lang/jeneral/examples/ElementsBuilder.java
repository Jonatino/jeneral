...
public abstract class ElementsBuilder<U> implements ElementsBuilder_Template<U> {
	...
	@ParamConstructor
	public abstract U new_T(U other) throws IOException;
	
	public U buildElement() throws IOException {
		return new_T(getArg());
	}
	
	public U buildElement(U other) throws IOException {
		return new_T(other);
	}
	...
	public static void main(String[] args) {
		...
		try {
			ElementsBuilder<Integer> intBuilder = ElementsBuilder_Template.Factory.newInstance(Integer.TYPE, "Default Label Text");
		...
		try {
			ElementsBuilder<Integer> intBuilder = ElementsBuilder_Template.Factory.newInstance(Integer.class, "Default Label Text");

...
import com.ochafik.lang.jeneral.examples.ReflectionUtils.ReflectionException;
...
public abstract class ElementsBuilder<T extends Comparable<T>> implements _ElementsBuilder<T> {
	...
	public T buildElement(T other) throws IOException {
		...
		try {
			T max = ReflectionUtils.getStaticField(T(), "MAX_VALUE");
			T max2 = ReflectionUtils.getField(max, "MAX_VALUE");
